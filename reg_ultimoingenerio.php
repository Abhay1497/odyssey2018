...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn) {
        ...
        $sql = "SELECT max(part_id) FROM ultimoingenerio";
        ...
        $sql = "insert into ultimoingenerio values('$name1','$mobile1','$email1','$name2','$mobile2','$email2','$name3','$mobile3','$email3','$name4','$mobile4','$email4','$college','$id')";
        if (mysqli_query($conn, $sql) == 1) {

            //sending email
//            $email_subject = "ODYSSEY Registration";
//            $email_body = "Thank you for registering in Treasure Hunt.\nYour Participation ID is ".$event_id;
...
//            sendWay2SMS ( "8197508688","R3694K",$mobile4,$email_body);
            ...
            <script language="javascript" type="text/javascript">
                ...
                window.location = "reg_ultimoingenerio.html";
            </script>
            <?php
        } else {
            ?>
