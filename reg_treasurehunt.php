...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn) {
        ...
        $sql = "SELECT max(part_id) FROM treasurehunt";
        ...
        $sql = "insert into treasurehunt values('$name1','$mobile1','$email1','$name2','$mobile2','$email2','$name3','$mobile3','$email3','$name4','$mobile4','$email4','$college','$id')";
...
//            sendWay2SMS ( "8197508688","R3694K",$mobile4,$email_body);
            ...
            <script language="javascript" type="text/javascript">
                ...
                window.location = "reg_treasurehunt.html";
            </script>
            <?php
        } else {
            ?>
