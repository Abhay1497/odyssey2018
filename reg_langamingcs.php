...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn) {
        ...
        $sql = "SELECT max(part_id) FROM langamingcs";
        ...
        $sql = "insert into langamingcs values('$name1','$mobile1','$email1','$name2','$mobile2','$email2','$name3','$mobile3','$email3','$name4','$mobile4','$email4','$college','$id')";
